...
export default function Navbar() {
  return (
    <nav className="self-center backdrop-blur-xl sticky flex items-center justify-between top-10 w-[85%] z-50 rounded-full border-2 border-fuchsia-400/30 p-4 bg-indigo-950/50 sm:px-8">
      <Explore />
