      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 md:gap-16 justify-items-center py-20 mb-16">
        {logos.map((logo) => (
          ...
          >
            ...
            <button className="mt-7 bg-violet-000 hover:bg-violet-900 outline-solid outline-purple-900 text-white font-bold py-2.5 transition-colors px-8 rounded-full ">
              {logo.buttonText}
            </button>
          </div>
        ))}
