...
export default function OpenProblems() {
  return (
    <div className="self-stretch">
      <h1 id='workshop-title' className={`text-4xl mb-12 font-bold text-center ${montserrat.className}`}>Research Projects</h1>
  ...
  return (
    <aside className='shrink-0 bg-stone-900 p-4 border border-gray-200 rounded hidden md:block md:w-60 xl:w-80 sticky top-30 h-max mb-16'>
      ...
      <ul className="space-y-2">
        <li><Link href='#genai' className="toc-link">Generative AI</Link></li>
