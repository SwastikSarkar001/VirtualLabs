...
export default function HeroSection() {
  return (
    <section className="relative h-screen flex flex-col items-center justify-center pt-10">
      <Image
        src='/background.png'
        fill
      ...
      <div className="flex flex-col items-start gap-4 w-[90%] sm:w-4/5 md:w-3/5 relative">
        ...
        <Link href='/start-learning' className="mt-2 z-2 cursor-pointer flex gap-2 items-center bg-gradient-to-b from-violet-700 to-violet-900 hover:to-violet-800 transition-colors py-2 px-4 rounded-xl">
          Start Learning!
        </Link>
      </div>
    </section>
