...
export default function Footer() {
  return (
    <footer className="mt-auto border-t-2 p-8 sm:p-12 sm:pb-8 border-violet-400/30 flex flex-col items-stretch gap-8 text-sm">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16 items-center">
        ...
        <div className="flex flex-col gap-1">
          <Link className="flex items-center gap-2 *:first:text-[1.2em]" href='https://www.facebook.com/vlead.iiithyd' passHref target="_blank">
            <BiLogoFacebook /><div>/vlead.iiithyd</div>
          </Link>
          <Link className="flex items-center gap-2 *:first:text-[1.2em]" href='https://twitter.com/TheVirtualLabs' passHref target="_blank">
            <RiTwitterXFill /><div>/TheVirtualLabs</div>
          </Link>
          <Link className="flex items-center gap-2 *:first:text-[1.2em]" href='https://www.youtube.com/@virtual-lab-experiments-ii4780' passHref target="_blank">
            <SiYoutube /><div>/@virtual-lab-experiments-ii4780</div>
          </Link>
          <Link className="flex items-center gap-2 *:first:text-[1.2em]" href='https://www.linkedin.com/in/virtual-labs-008ba9136' passHref target="_blank">
            <BiLogoLinkedin /><div>/virtual-labs-008ba9136</div>
          </Link>
          <Link className="flex items-center gap-2 *:first:text-[1.2em]" href='https://www.instagram.com/thevirtuallabs' passHref target="_blank">
      ...
      <div className="border-t-2 border-gray-500/30 pt-4 flex items-center justify-center">
